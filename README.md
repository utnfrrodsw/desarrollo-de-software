...
| Actividad                                                  | Puntaje |
|------------------------------------------------------------|:-------:|
| TP desarrollo de Backend (TPBack) alcance parcial          | 40      |
| TP desarrollo de Frontend (TPFront) alcance parcial        | 40      |
| Prueba de Concepto (PoC)                                   | 30      |
| Evaluación de Desarrollo (Parcial) alcance parcial         | 40      |
| Total                                                      | 150     |
| Necesario para regularidad (60%)                           | 90      |

¿Cómo calcular su puntaje?

(Nota TPBack * 40 + Nota TPFront * 40 + Nota PoC * 30 + Nota Parcial * 40) / 150
...
(7 * 40 + 7 * 40 + 7 * 30 + 7 * 40)/150 => (280 + 280 + 210 + 280)/150 => 1050/150 => 7 => Regular
...
(4 * 40 + 4 * 40 + 4 * 30 + 9 * 40)/150 => (160 + 160 + 120 + 360)/150 => 800/150 => 5,33 => Libre

### Aprobación directa
La aprobación directa se alcanza con el 60% de los puntos de las actividades de aprobación:
| Actividad                                          | Puntaje |
|----------------------------------------------------|:-------:|
| TP desarrollo de Backend alcance completo          | 35      |
| TP desarrollo de Frontend alcance completo         | 35      |
...
La fecha para la primera presentación de regularidad o AD entre los días 12/10/2026 y 16/10/2026.

La fecha para el primer globalizador de regularidad y recuperatorio de AD será en el horario de clases entre los días 26/10/2026 y 30/10/2026.
